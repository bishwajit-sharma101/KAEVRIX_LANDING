    ...
    <div className="matchmaking-container lobby-container">
      ...
      <div className="vs-container">
        ...
        <div className={`vs-player-card ${isOpponentReady ? "ready-card-glow-pink" : "not-ready-card"}`}>
          <div className="vs-player-avatar vs-opponent-avatar" style={{ overflow: "hidden" }}>
            <img src={opponent?.avatar || `https://api.dicebear.com/7.x/bottts/svg?seed=${encodeURIComponent(opponent?.username || "bot")}&backgroundColor=transparent`} alt="avatar" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
      ...
      <div style={{ display: "flex", gap: "20px", marginTop: "10px", marginBottom: "30px" }}>
        ...
        >
          {room?.generatingQuiz ? "AI Generating Quiz..." : (isMeReady ? "READY LOCKED" : "CHOOSE READY")}
        </button>
