...
const STATUS_LOGS = [
  "[SIGNAL] Contacting matchmaking server nodes...",
  "[SEARCH] Scanning arena for real opponents...",
  "[SPEC] Filtering players with compatible skill seeds...",
  "[BOSS] Setting up virtual arena variables...",
  "⏳ Waiting for a challenger to join...",
  "[VS]️ Preparing the battlefield...",
  "[GOAL] Searching for a worthy rival...",
  "[STREAK] Arena is heating up..."
];
  ...
  return (
    <div className="matchmaking-container">
      ...
      <div style={{
        ...
        {remaining <= 10 ? "[XP] Bot match starting soon..." : "Waiting for a real opponent to join this video"}
      </div>
